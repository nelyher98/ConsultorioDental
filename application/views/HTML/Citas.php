<html class="no-js" lang="">
   ...
   <aside class="Flex3">
       ...
       <a href="Citas.html"><H3 class="sub3">Citas</H3></a>
       <a href="Login.html"><H3 class="sub3">Salir</H3></a>
    ...
    <section class="Flex4">
        ...
        <form action="#" method = "POST">
           ...
           <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <tr><td>&nbsp;</td></tr>
            <tr>
                 <td><input type="checkbox" name="Diabetes" value="Diabetes"> Diabetes</td>
            </tr>
                <tr><td>&nbsp;</td></tr>
            <tr>
                <td><input type="checkbox" name="Hiper" value="Hiper"> Hipertensión</td>
            </tr>
                <tr><td>&nbsp;</td></tr>
            <tr>
                <td><input type="checkbox" name="Alcohol" value="Alcohol"> Alcoholismo</td>
            </tr>
                <tr><td>&nbsp;</td></tr>
            <tr>
                <td>Presión: </td>
             ...
             <tr>
               ...
               <tr><td>&nbsp;</td></tr>
             <tr>
                 <td colspan="2">Urgencia:</td>
             </tr>
                <tr><td>&nbsp;</td></tr>
             <tr>
                 <td><input type="checkbox" name="Alta" value="Alta">Alta </td>
            </tr>
                <tr><td>&nbsp;</td></tr>
            <tr>
                ...
                <tr><td>&nbsp;</td></tr>
            <tr>
                <td><input type="checkbox" name="Baja" value="Baja">Baja </td>
            </tr>
                <tr><td>&nbsp;</td></tr>
            <tr>
           ...
           <tr>
                ...
                <tr><td>&nbsp;</td></tr>
           <tr>
              <td colspan="2"><textarea cols="25"></textarea> </td> 
           </tr>
                <tr><td>&nbsp;</td></tr>
           <tr>
                <td>Fecha: </td>
